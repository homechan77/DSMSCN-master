...
def get_FCSD_model(input_size, pre_weights=None):
    ...
    #concatenate the absolute value of their difference
...
#keras.backend.abs: Element-wise absolute value(요소별 절대값)
...
def expansive_path(feature, diff_1, diff_2, diff_3, diff_4):
    ...
    Deconv_4 = Conv2D(16, 3, activation='relu', padding='same', kernel_initializer='he_normal')(Merge_4)
    # Deconv_4 = BatchNormalization()(Deconv_4)
    Deconv_4 = Conv2D(2, 3, activation='relu', padding='same', kernel_initializer='he_normal')(Deconv_4)
    # Deconv_4 = BatchNormalization()(Deconv_4)
